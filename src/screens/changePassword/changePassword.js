...
const ForgotPassScreen = (props) => {
  ...
  const resetPass = async () => {
    if (otp.length < 5) {
      ...
      Alert.alert('Error', 'Entrez correctement votre mot de passe', [
        {text: 'Okay', style: 'default'},
      ]);
    } else {
      setLoading(true);
  ...
  const sendOtpHandler = async () => {
    if (phone.length < 10) {
      ...
      //   ToastAndroid.SHORT,
      // );
      Alert.alert('Error', 'Entrer correctement votre numéro', [
        {text: 'Okay', style: 'default'},
      ]);
    } else {
      setError(null);
        ...
        <View style={styles.midContainer}>
          ...
          <Card style={styles.card}>
            ...
            <View style={styles.newPassTextContainer}>
              <Text style={styles.loginLineText}>Entrez le nouveau mot de passe</Text>
            </View>
